...
urlpatterns = [
    ...
    path("check-for-live-workout-session",views.check_for_live_workout_session,name="check-for-live-workout-session"),
    ...
    path("rename-empty-workout",views.rename_empty_workout,name="rename-empty-workout"),
